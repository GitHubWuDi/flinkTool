 ...
 * @version 创建时间：2018年10月25日 上午11:46:29 
 * 类说明:说明文档见：https://blog.csdn.net/xu470438000/article/details/79508962
 */
public class WikipediaAnalysis {
	
	public static final String KAFKA_URL  = "192.168.118.81:9092";
	public static final String TOPIC_NAME = "flink-wiki-demo";
	...
	public static void main(String[] args) throws Exception {
	    ...
	    .addSink(new FlinkKafkaProducer08<>(KAFKA_URL,TOPIC_NAME, new SimpleStringSchema()));
